...
<head>
    ...
    {{-- all css and js of app are assets as bundling here by @vite([])  and vite configured in vite.cnfig.js file --}}
...
{{--             <div class="content-header">
 ...
 --}}
            ...
            {{-- Application Main  Content Div Start --}}
{{--             <div class="content">
                
            </div> --}}
            {{-- Application Main Content Div End --}}
